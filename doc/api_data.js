define({ "api": [
  ...
  },
  {
    "type": "get",
    "url": "/orcamentos",
    "title": "Consultar orçamentos no periodo",
    "version": "1.0.0",
    "name": "getOrcamentos",
    "group": "Orcamentos",
    "description": "<p>Esta requisição retorna um array de orçamentos geradas no período informado, de acordo com a página informada. Os itens dos orçamentos não serão retornados.</p>",
    "header": {
      "fields": {
        "Header": [
          {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "id_plano_pag",
            "description": "<p>Lista de ID de planos de pagamentos, separados por &quot;|&quot;. Ex.: &quot;001|005|012&quot;</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "situacao",
            "description": "<p>Lista de situações, separadas por &quot;|&quot;. Ex.: &quot;P|C|F&quot; para consultar orçamentos Pendentes, Cancelados e Faturados.</p>"
          }
        ]
      }
    },
    ...
    "filename": "./routes/cadastros/orcamentos.js",
    "groupTitle": "Orçamentos"
  },
  {
    "type": "get",
    "url": "/orcamentos/:numero",
    "title": "Consultar um orçamento pelo número",
    "version": "1.0.0",
    "name": "getOrcamentosNumero",
    "group": "Orcamentos",
    "header": {
      "fields": {
        "Header": [
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "numero",
            "description": "<p>Número do orçamento a ser consultado.</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "id_loja",
            "description": "<p>ID da loja onde o orçamento foi gerado</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "numero",
            "description": "<p>Número da orçamento.</p>"
          },
          {
            "group": "Success 200",
            "type": "Date",
            "optional": false,
            "field": "data",
            "description": "<p>Data de geração do orçamento.</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "id_tab_preco",
            "description": "<p>ID da tabela de preço usada no orçamento.</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "qt_itens",
            "description": "<p>Número de itens lançados no orçamento.</p>"
          },
          {
            "group": "Success 200",
            "type": "Number",
          ...
          },
          {
            ...
            "optional": false,
            "field": "vl_total",
            "description": "<p>Valor total do orçamento.</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "situacao",
            "description": "<p>Situação da orçamento: P-Pendente F-Faturado C-Cancelado</p>"
          },
          {
            "group": "Success 200",
            "type": "Date",
          ...
          },
          {
            ...
            "optional": false,
            "field": "itens",
            "description": "<p>Array contendo a lista de itens do orçamento.</p>"
          }
        ],
  ...
  {
    "type": "get",
    "url": "/orcamentos/:numero/itens",
    "title": "Consultar os itens de um orçamento",
    "version": "1.0.0",
    "name": "getOrcamentosNumeroItens",
    "group": "Orcamentos",
    "header": {
      "fields": {
        "Header": [
  ...
  },
  {
    "type": "post",
    "url": "/orcamentos",
    "title": "Gerar uma novo orçamento",
    "version": "1.0.0",
    "name": "postOrcamento",
    "group": "Orcamentos",
    "header": {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id_venda",
            "description": "<p>ID da venda temporária a ser transformada em orçamento.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": true,
            "field": "hora_entrega",
            "description": "<p>Horario previsto para entrega (HH:MM).</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "numero",
            "description": "<p>Número do orçamento gerado.</p>"
          },
          {
            "group": "Success 200",
            "type": "Number",
            "optional": false,
            "field": "vl_total",
            "description": "<p>Valor total do orçamento gerado.</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "situacao",
            "description": "<p>Lista de situações, separadas por &quot;|&quot;. Ex.: &quot;P|C|F&quot; para consultar pré-vendas Pendentes, Canceladas e Faturadas.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "id_posicao",
            "description": "<p>Lista de ID de posições de pré-vendas, separadas por &quot;|&quot;. Ex.: &quot;01|02|03&quot;</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/produtos/tabprecos/:id",
    "title": "Consultar tabelas de preços",
    "version": "1.0.0",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "descricao",
            "description": "<p>Descrição da tabela de preços.</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "delete",
    "url": "/vendas/:id_venda/itens/:id_item",
    "title": "Excluir um item da venda",
    "version": "1.0.0",
  ...
  },
  {
    "type": "get",
    "url": "/vendas/:id_venda/itens/:id_item",
    "title": "Consultar um ou mais itens de uma venda",
    "version": "1.0.0",
    "name": "getVendaItens",
    "group": "Vendas",
    "header": {
  ...
  },
  {
    "type": "get",
    "url": "/vendas",
    "title": "Consultar as vendas em andamento",
    "version": "1.0.0",
    "name": "getVendasTemp",
    "group": "Vendas",
    "header": {
  ...
  {
    "type": "put",
    "url": "/vendas/:id_venda/precos",
    "title": "Alterar a tabela de preços da venda",
    "version": "1.0.0",
